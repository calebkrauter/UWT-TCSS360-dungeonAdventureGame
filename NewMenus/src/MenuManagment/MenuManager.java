...
public class MenuManager extends JPanel {
    ...
    private void addMainMenu() {
        ...
        modifyInsets.setInsets(200, 0, 0, 0);
    ...
    private void addCharacterSelectMenu() throws IOException {
        ...
        modifyInsets.setInsets(500, -800, 0, 0);
    ...
    private void addOptionsActions() {
        myVolumeSlider.addChangeListener(e -> new VolumeChange());
        myAudioToggle.addActionListener(e -> new ToggleAudioChange());
        myMusicToggle.addActionListener(e -> new ToggleMusicChange());
...
//        }
    ...
    final BufferedImage hero1 = ImageIO.read(new File("C:\\Users\\Kraut\\Documents\\Workspace\\360-Dungeon-Adventure\\NewMenus\\man1.png"));
    final BufferedImage hero2 = ImageIO.read(new File("C:\\Users\\Kraut\\Documents\\Workspace\\360-Dungeon-Adventure\\NewMenus\\man2.png"));
    final BufferedImage hero3 = ImageIO.read(new File("C:\\Users\\Kraut\\Documents\\Workspace\\360-Dungeon-Adventure\\NewMenus\\man3.png"));
